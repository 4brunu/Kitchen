...
${OBJECTDIR}/PeanutApi.o: PeanutApi.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeanutApi.o PeanutApi.cpp

${OBJECTDIR}/PeanutHandler.o: PeanutHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeanutHandler.o PeanutHandler.cpp

${OBJECTDIR}/PeanutService.o: PeanutService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeanutService.o PeanutService.cpp

${OBJECTDIR}/PeanutSheaButter.o: PeanutSheaButter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeanutSheaButter.o PeanutSheaButter.cpp

${OBJECTDIR}/PeanutStore.o: PeanutStore.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeanutStore.o PeanutStore.cpp

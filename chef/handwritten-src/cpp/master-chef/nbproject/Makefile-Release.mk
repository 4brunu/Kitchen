...
${OBJECTDIR}/MasterChef.o: MasterChef.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MasterChef.o MasterChef.cpp

${OBJECTDIR}/MasterChefApi.o: MasterChefApi.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MasterChefApi.o MasterChefApi.cpp

${OBJECTDIR}/MasterChefHandler.o: MasterChefHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MasterChefHandler.o MasterChefHandler.cpp

${OBJECTDIR}/MasterChefMenu.o: MasterChefMenu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MasterChefMenu.o MasterChefMenu.cpp

${OBJECTDIR}/MasterChefService.o: MasterChefService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MasterChefService.o MasterChefService.cpp

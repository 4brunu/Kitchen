...
class NativeRecipe final : ::djinni::JniInterface<::naomi_gen::Recipe, NativeRecipe> {
public:
    using CppType = std::shared_ptr<::naomi_gen::Recipe>;
    using CppOptType = std::shared_ptr<::naomi_gen::Recipe>;
...
private:
    ...
    friend ::djinni::JniInterface<::naomi_gen::Recipe, NativeRecipe>;

...
class NativeApi final : ::djinni::JniInterface<::naomi_gen::Api, NativeApi> {
public:
    using CppType = std::shared_ptr<::naomi_gen::Api>;
    using CppOptType = std::shared_ptr<::naomi_gen::Api>;
...
private:
    ...
    friend ::djinni::JniInterface<::naomi_gen::Api, NativeApi>;
